This project demonstrates the use of WebRTC (Web Real-Time Communication) to enable peer-to-peer communication between browsers. It supports features like audio, video, and data sharing in real-time.
